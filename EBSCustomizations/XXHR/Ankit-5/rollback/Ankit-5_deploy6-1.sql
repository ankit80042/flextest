...
DROP INDEX Ben79_EMP_DEPT_IDX;

-- Step 2: Remove the sequence
DROP SEQUENCE Ben79_EMP_SEQ;

-- Step 3: Remove the table and all its data
DROP TABLE Ben79_EMPLOYEES CASCADE CONSTRAINTS;

-- Step 4: Commit
COMMIT;

-- Verify rollback was successful
SELECT COUNT(*) FROM USER_TABLES WHERE TABLE_NAME = 'Ben79_EMPLOYEES';
