...
DROP INDEX Ben88_EMP_DEPT_IDX;

-- Step 2: Remove the sequence
DROP SEQUENCE Ben88_EMP_SEQ;

-- Step 3: Remove the table and all its data
DROP TABLE Ben88_EMPLOYEES CASCADE CONSTRAINTS;
...
SELECT COUNT(*) FROM USER_TABLES WHERE TABLE_NAME = 'Ben88_EMPLOYEES';
